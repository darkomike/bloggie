...
const team = [
  { name: 'Michael Ofosu Darko', role: 'Founder & CEO', avatar: 'MD' },
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
      <div className="grid gap-12 md:gap-16 md:grid-cols-2 items-center">
        ...
        <div className="relative">
          <div className="aspect-square rounded-2xl md:block bg-linear-to-br from-blue-400 to-purple-500 dark:from-blue-600 dark:to-purple-700"></div>
        </div>
      </div>
    </div>
  );
        ...
        {team.map((member) => (
          <div key={member.name} className="text-center group">
            <div className="relative mb-4 sm:mb-6 inline-block">
              <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-linear-to-br from-blue-400 to-purple-500 dark:from-blue-600 dark:to-purple-700 flex items-center justify-center text-white text-3xl sm:text-4xl font-bold group-hover:scale-110 transition-transform">
                {member.avatar}
              </div>
            </div>
...
function CTASection() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
      <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-800 dark:to-purple-900 px-6 py-12 sm:px-12 sm:py-16 md:px-16 md:py-20 text-center">
