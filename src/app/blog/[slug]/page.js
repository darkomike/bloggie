        ...
        <div className="mx-auto max-w-4xl px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 pb-6 sm:pb-8 mb-8 sm:mb-10 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between gap-3 sm:gap-4 flex-1">
              <Link
                href={post.author?.uid ? `/user/${post.author.uid}` : '#'}
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      {user?.uid && comment.user?.id === user.uid && (
                        <button
                          className="ml-4 px-3 py-1.5 sm:px-3 sm:py-1.5 text-xs font-medium rounded-md bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors flex items-center gap-1"
