...
export default function SignupForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call signup action - it updates the user state immediately
      ...
      // Signup failed, error is already set in Context state
    ...
    <div className="w-full max-w-md">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">3-30 characters, lowercase letters, numbers, hyphens, underscores, and dots</p>
        </div>
        ...
        {(localError || authError) && (
          <div className="rounded-md bg-red-50 p-4 dark:bg-red-900/20">
            <p className="text-sm text-red-800 dark:text-red-300">{localError || authError}</p>
          </div>
        )}
